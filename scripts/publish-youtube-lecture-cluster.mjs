...
const koSlugs = [
  ...
  "organize-lecture-videos-into-notes",
  "summarize-youtube-lectures-for-review",
  "why-structure-video-content",
  "check-ai-youtube-summaries",
  "extract-key-concepts-from-lecture-videos",
  "youtube-transcript-summary-mistakes",
  "find-important-parts-in-long-videos",
  "youtube-summary-tool-checklist",
  "turn-lecture-videos-into-review-materials",
