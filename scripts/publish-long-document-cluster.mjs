...
const koSlugs = [
  ...
  "common-pdf-summary-mistakes",
  "why-document-structuring-matters",
  "how-to-read-long-reports-faster",
  "pdf-summary-tool-checklist",
  "organize-meeting-documents",
  "summarize-manuals-and-guides",
  "compare-multiple-pdfs",
  "extract-key-questions-from-documents",
  "check-ai-document-summary",
  "use-document-summary-for-reporting",
  "make-long-documents-searchable",
];
