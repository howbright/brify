...
const koSlugs = [
  ...
  "why-paper-summary-is-not-enough",
  "ai-paper-summary-tool-checklist",
  "paper-organization-routine-for-grad-students",
  "can-you-read-only-paper-abstract",
  "how-to-read-papers-faster",
  "pdf-paper-summary-mistakes",
  "research-paper-organization-checklist",
  "paper-summary-for-report-risk",
  "chatgpt-paper-summary-checkpoints",
  "research-paper-notes-structure",
  "compare-multiple-research-papers",
  "can-you-trust-ai-paper-summary",
  "how-to-summarize-paper-methods",
  "paper-results-vs-conclusion",
  "why-paper-limitations-matter",
  "paper-summary-for-presentation",
  "what-to-check-after-ai-paper-organization",
];
