...
const KO_COPY: TermsCopy = {
  ...
  subtitle:
    "브리파이는 텍스트, 웹페이지, 유튜브 영상 대본 등을 구조적으로 정리해 주는 서비스입니다. 아래 약관은 계정 이용, 입력 콘텐츠, AI 생성 결과, 크레딧 결제와 공유 기능에 대한 기본 기준을 설명합니다.",
  ...
  sections: [
    {
      ...
      title: "1. 목적 및 적용 범위",
      paragraphs: [
        "본 약관은 Brify(이하 “회사” 또는 “서비스”)가 제공하는 구조화, 구조맵 생성, 저장, 수정, 공유 등 관련 제반 서비스의 이용과 관련하여 회사와 이용자 간의 권리, 의무 및 책임사항을 규정하는 것을 목적으로 합니다.",
    ...
    },
    {
      ...
      title: "2. 서비스 내용",
      paragraphs: [
        "회사는 이용자에게 텍스트, 웹페이지 URL, 유튜브 링크, 직접 작성한 메모 등 다양한 입력을 바탕으로 구조화문, 키워드, 구조맵 등 정리 결과를 제공할 수 있습니다.",
        "회사는 서비스의 품질 향상, 안정성 확보, 정책 변경 또는 외부 연동 변경 등을 위해 서비스의 일부 기능을 추가, 수정 또는 중단할 수 있습니다.",
      ],
      items: [
        "텍스트 및 링크 기반 콘텐츠 추출과 정리",
        "AI 기반 구조화, 키워드 생성, 구조맵 생성",
    ...
    },
    {
      ...
      paragraphs: [
        "Brify는 인공지능 또는 자동화 기술을 활용하여 구조화문, 키워드, 구조맵 등 생성 결과물을 제공합니다.",
