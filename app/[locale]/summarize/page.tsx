      ...
      <div className="py-12 px-6 mx-auto max-w-3xl w-full">
        ...
        <form action="#">
          <textarea
            ...
            className="block w-full p-4 text-base text-gray-900 bg-gray-50 border border-gray-300 rounded-xl shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-800 dark:border-gray-600 dark:text-white dark:placeholder-gray-400"
          ></textarea>

          <div className="flex justify-center mt-10">
            <button
              type="submit"
              className="px-8 py-4 text-lg font-bold text-white bg-primary-700 rounded-xl hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900 shadow-lg transition"
            >
              ✨ 요약 시작하기
            </button>
          </div>
