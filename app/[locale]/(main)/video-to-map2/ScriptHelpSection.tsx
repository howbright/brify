    ...
    >
      ...
      >
        <div className="flex-1 flex flex-col items-start gap-1 min-w-0">
          <span
            className="
              text-[11px] px-2 py-0.5 rounded-full border border-blue-200 bg-blue-50 text-blue-700
              dark:border-[rgb(var(--hero-b))]/35 dark:bg-white/8 dark:text-[rgb(var(--hero-b))]
            "
          >
            {t("badge")}
          </span>
          ...
          <div className="flex flex-col gap-5 text-[13px] md:text-sm text-neutral-700 dark:text-neutral-200">
              ...
              <div className="flex gap-3 md:gap-4 items-start">
                <div
                  className="
                    ...
                    bg-blue-50 text-[11px] font-semibold text-blue-700
                    dark:bg-white/8 dark:text-[rgb(var(--hero-b))]
                  "
                >
                  1
                </div>
                <div className="flex-1 flex flex-col gap-2">
                  ...
                  <p className="text-[13px] md:text-sm text-neutral-600 dark:text-neutral-300">
                    {t("step1.body")}
                  </p>
                  <div
                    className="
                      mt-1 overflow-hidden rounded-2xl
                      border border-neutral-200/80 bg-neutral-50/60
              ...
              <div className="flex flex-col gap-2.5">
                ...
                <div className="flex gap-2.5 items-start">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="mt-0.5 text-[13px] md:text-sm text-neutral-600 dark:text-neutral-300">
                      {t("case1.body")}
                    </p>
                  </div>
                </div>
            ...
            <div
              className="
                ...
                p-3 text-[13px] md:text-sm text-neutral-700
                dark:border-white/12 dark:bg-white/6 dark:text-neutral-200
              "
            >
              <p className="font-semibold text-neutral-900 dark:text-neutral-50 mb-1">
                {t("faq.title")}
              </p>
              <ul className="list-disc list-inside flex flex-col gap-0.5 text-neutral-700 dark:text-neutral-200">
                <li>{t("faq.item1")}</li>
                <li>{t("faq.item2")}</li>
                <li>{t("faq.item3")}</li>
              </ul>
