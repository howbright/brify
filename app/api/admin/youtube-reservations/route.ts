...
export async function GET() {
  ...
  const { data: reservations, error } = await db
    ...
    .select(
      "id,user_id,requester_email,url,video_id,output_language,status,status_reason,required_credits,charged_credits,credit_snapshot,result_map_id,admin_notes,processed_at,created_at,updated_at"
    )
