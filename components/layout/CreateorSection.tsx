        ...
        >
          ...
          <div className="-mt-1 sm:-mt-2 relative">
            <div
              ...
              "
            >
              {/* 꼬리 (위쪽 중앙, 아바타와 시각적 결합) */}
              <svg
                aria-hidden
                className="absolute left-1/2 -translate-x-1/2 -top-3 h-4 w-6 text-white/80 dark:text-black/40"
                viewBox="0 0 24 24"
              >
              ...
              <p className="text-[17px] leading-8 sm:text-[19px] sm:leading-9 tracking-tight mb-1">
                “볼 것은 많은데 <b>시간은 늘 모자라더군요</b>.
                <br />
                영상 보며 ‘정말 유익하다’고 느꼈는데, 저녁이면 <b>절반도 기억이 나지 않았습니다</b>.
                <br />
                ‘<span className="font-semibold text-blue-700 dark:text-[rgb(var(--hero-b,_99,102,241))]">나중에 봐야지</span>’ 하고 미뤘다가 결국 못 본 영상도 적지 않았습니다.
                <br />
                <b>건강</b>과 <b>아이들 교육</b>, <b>재테크</b>까지 챙겨야 할 것들이 겹치니 더더욱 놓치기 쉬웠습니다.
                <br />
                그래서 <b className="font-extrabold">도구를 직접 만들었습니다</b>. 방금 본 내용을 <b>트리로 정리</b>해 두면, 다시 열어도 <b>흐름과 요지</b>가 남습니다.”
              </p>
            </div>
          </div>
