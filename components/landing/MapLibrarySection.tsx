...
function SectionCard({
  ...
  return (
    <motion.article
      ...
      className={`flex h-full flex-col rounded-[28px] border border-slate-200 bg-white p-5 shadow-[0_18px_50px_-30px_rgba(15,23,42,0.2)] dark:border-white/10 dark:bg-white/[0.04] dark:shadow-[0_18px_50px_-30px_rgba(56,189,248,0.18)] ${className ?? ""}`}
    >
...
function TagVisual() {
  return (
    <div className="rounded-[24px] bg-slate-50 p-4 dark:bg-white/[0.03]">
...
function MergeVisual() {
  return (
    <div className="w-full rounded-[24px] bg-slate-50 p-4 dark:bg-white/[0.03]">
...
export default function MapLibrarySection() {
  ...
  return (
    <section className="relative -mt-6 bg-[#eaf2ff] px-6 py-6 dark:bg-[#10203a] md:-mt-10 md:px-10 md:py-10">
      <div className="mx-auto max-w-7xl rounded-[32px] border border-blue-100 bg-[linear-gradient(180deg,#f8fbff_0%,#ffffff_100%)] p-6 shadow-[0_24px_80px_-40px_rgba(37,99,235,0.24)] dark:border-blue-400/20 dark:bg-[linear-gradient(180deg,#0f172a_0%,#0b1220_100%)] dark:shadow-[0_24px_80px_-40px_rgba(59,130,246,0.24)] md:p-8">
