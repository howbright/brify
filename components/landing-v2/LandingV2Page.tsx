...
const COPY = {
  ko: {
    ...
    loadingSteps: [
      ...
      "큰 주제들을 나누는 중입니다",
      "전체 구조의 뼈대를 배치하고 있어요",
      "큰 구조가 완성되면 바로 열어드릴게요",
    ],
    processingTitle: "큰 주제를 정리하는 중입니다",
    processingBullets: [
      "긴 문서를 먼저 큰 구조로 나누고 있어요.",
      "큰 구조가 완성되면 필요한 주제에서 ‘깊게 보기’를 눌러 세부 구조를 요청할 수 있어요.",
  ...
  en: {
    ...
    loadingSteps: [
      ...
      "Separating the main topics",
      "Arranging the high-level structure",
      "Opening it as soon as the big structure is ready",
    ],
    processingTitle: "Organizing the main topics",
    processingBullets: [
      "We’re first dividing the long document into a high-level structure.",
      "Once the big structure is ready, use “Go deeper” on the topics you need.",
  ...
  fr: {
    ...
    loadingSteps: [
      ...
      "Séparation des grands sujets",
      "Organisation de la structure générale",
      "Ouverture dès que la grande structure est prête",
    ],
    processingTitle: "Organisation des grands sujets",
    processingBullets: [
      "Nous divisons d’abord le long document en une structure générale.",
      "Quand la grande structure est prête, utilisez « Approfondir » sur les sujets nécessaires.",
